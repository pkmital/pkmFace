...
public:
	...
	void CalcWarpTexture(const CvMat* s, const IplImage* image,	
	...
	void TextureToImage(IplImage* image, const CvMat* t, int nPlane)const;
	void SaveWarpTextureToImage(const char* filename, const CvMat* t, int nPlane)const;
